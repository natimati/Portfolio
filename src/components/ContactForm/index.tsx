...
import { Container, Form, FormInput, InputError, RodoInformation, Message, SendButton, ReCAPTCHAContainer, NameInputContainer, EmailInputContainer, MessageInputContainer, Label } from './style';
    ...
    return (
      <Container>
        ...
        <RodoInformation>
          ...
          Personal data provided via the contact form will be processed only for
          the purpose of responding to your message. <br />
          You have the right to withdraw consent at any time and request access,
          rectification, deletion and limitation of your data. Providing
          personal data is voluntary, however, without providing it, we will not
          be able to respond to the message.
        </RodoInformation>
      </Container>
    );
}
