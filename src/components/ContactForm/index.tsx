  ...
  return (
    <Container>
      ...
      <Form onSubmit={onSubmit}>
        ...
        <EmailInputContainer>
          ...
          <InputError>
            ...
            {errors.email?.type === "minLength" && "Use at least 6 characters"}
      ...
      <RodoInformation>
        ...
        rectification, deletion and limitation of your data. Providing personal
        data is voluntary, however, without providing it, we will not be able to
